        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'review',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'review')
                  : const ReviewWidget(),
            ),
            FFRoute(
              name: 'courses',
            ...
            FFRoute(
              name: 'FuricPatrikReviews',
              path: 'furicPatrikReviews',
              builder: (context, params) => const FuricPatrikReviewsWidget(),
            ),
            FFRoute(
              name: 'MyReviews',
              path: 'myReviews',
